#!/usr/bin/env bash
# ENTRY-FIX LANE · the ONLY way this lane starts anything.
#
# IRON PORTS (this lane, never shared): world 8460 · client 5193 · quest 4693.
...
cd "$(dirname "$0")/.."
ROOT=$(pwd)
SCRATCH="$ROOT/.scratch/entry-fix"
WORLD="$SCRATCH/world"
QDATA="$SCRATCH/quest"
GAIA_PORT_L=${GAIA_PORT_L:-8460}
CLIENT_PORT=${CLIENT_PORT:-5193}
QUEST_PORT_L=${QUEST_PORT_L:-4693}
...
EOF
  ...
  down)
    ...
    echo "lane down"
    ;;
  *) echo "usage: entry-fix-stack.sh [up|down]"; exit 1;;
esac
